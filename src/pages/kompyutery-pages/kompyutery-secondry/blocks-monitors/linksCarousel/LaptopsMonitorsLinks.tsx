  ...
  const picLinksCarousel = [
    {
      ...
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/sistemnye-bloki-220x220.jpg',
    },
    {
      path: '/sistemnye-bloki',
      name: 'Системные блоки игровые',
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/igrovye-sistemnye-bloki-220x220.jpg',
    },
    {
      path: '/monitory',
      name: 'Мониторы',
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/monitory-220x220.jpg',
    },
    {
      path: '/sistemnye-bloki',
      name: 'Системные блоки',
