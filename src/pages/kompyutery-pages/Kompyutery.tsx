...
const Kompyutery: React.FC = () => {
  const ComputerLinksForCarousel = [
    ...
    },
    {
      ...
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/kompyutery-i-monitory-220x220.jpg',
    },
    {
    ...
    },
    {
      ...
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/komplektuyushchie-220x220.jpg',
    },

    {
      ...
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/periferijnye-ustrojstva-220x220.jpg',
    },
    {
      path: '/komputernye-aksessuary',
      name: 'Аксессуары',
      imgUrl:
        'https://static.mvideo.ru/media/Assets/img/pc/aksessuary-220x220.jpg',
    },
  ];
  return (
